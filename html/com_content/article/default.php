...
<?php $useDefList = (($params->get('show_modify_date')) or ($params->get('show_publish_date'))
	...
	<div class=" img-responsive col-md-offset-2 col-md-8 col-sm-offset-2 col-sm-8 col-xs-offset-2 col-xs-8 pull-<?php echo htmlspecialchars($imgfloat); ?> item-image"> <img
	<?php $caption = '';?>
	<?php if ($images->image_fulltext_caption):
		$caption = 'caption';
		echo ' title="' .htmlspecialchars($images->image_fulltext_caption) .'"';
	endif; ?>
    <?php echo ' class="img-thumbnail img-responsive '.$caption.'" ';?>
	src="<?php echo htmlspecialchars($images->image_fulltext); ?>" alt="<?php echo htmlspecialchars($images->image_fulltext_alt); ?>"/></div><div class="clearfix"></div>
	<?php endif; ?>
	<?php
